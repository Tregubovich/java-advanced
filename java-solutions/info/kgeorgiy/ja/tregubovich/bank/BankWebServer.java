...
//    <td>{level}</td>
    ...
    private final Map<String, App> apps = new TreeMap<>(Map.ofEntries(
            app("Client 1", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.tregubovich.bank.Client", "Andrey", "Tregubovich", "497192", "1", "1000"),
            app("Client 2", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.tregubovich.bank.Client", "Andrey", "Tregubovich", "497192", "2", "100"),
            app("Client 3", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.tregubovich.bank.Client", "Andrey", "Solonenko", "289138", "3", "200"),
            app("Client 4", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.tregubovich.bank.Client", "Ivan", "Olkhov", "151620", "4", "500"),
            app("Server 1", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.tregubovich.bank.Server", "8881"),
            app("Server 2", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.tregubovich.bank.Server", "8882"),
